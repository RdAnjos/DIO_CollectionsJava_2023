...
public class CatalogoLivros {
    ...
    public List<Livro> pesquisarPorIntervaloAnos(int anoInical, int anoFinal){
        //Validando se a lista esta vazia.
        List<Livro> livrosPorIntervaloAnos = new ArrayList<>();
        if (!livroList.isEmpty()){
            for(Livro l: livroList){
                if(l.getAnoPublicacao() >= anoInical && l.getAnoPublicacao() <= anoFinal){
    ...
    public static void main(String[] args) {
        ...
        System.out.println(catalogoLivros.pesquisarPorIntervaloAnos(2011, 2020));
